...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const SKINS = [
			{
				...
				tokens: {
					...
					"--dsw-alias-bg-layer-2": "rgba(255, 255, 255, 0.065)",
			...
			},
			{
				...
				tokens: {
					...
					"--dsw-alias-bg-layer-3": "rgba(255, 255, 255, 0.085)",
			...
			},
			{
				...
				colorScheme: "light",
				tokens: {
					// iOS/Linear 清透亮色重构：干净冷白底 + 纯白面板 + 鲜亮靛蓝强调
					"--dsw-alias-bg-base": "#f7f8fa",
					"--dsw-alias-bg-layer-1": "rgba(255, 255, 255, 0.9)",
					"--dsw-alias-bg-layer-2": "rgba(255, 255, 255, 0.95)",
					"--dsw-alias-bg-layer-3": "rgba(240, 243, 248, 1)",
					"--dsw-alias-bg-overlay": "rgba(255, 255, 255, 0.92)",
					"--dsw-alias-border-l1": "rgba(17, 24, 39, 0.08)",
					"--dsw-alias-border-l2": "rgba(17, 24, 39, 0.14)",
					"--dsw-alias-label-primary": "#111827",
					"--dsw-alias-label-secondary": "#4b5563",
					"--dsw-alias-label-tertiary": "#6b7280",
					"--dsw-alias-brand-primary": "#4f6ef7",
					"--dsw-alias-brand-text": "#ffffff",
					"--dsw-alias-button-primary-hover": "#5f7cf8",
					"--dsw-alias-button-primary-dimmed": "rgba(79, 110, 247, 0.10)",
					"--dsw-alias-state-business-primary": "#4f6ef7",
					"--dsw-alias-state-business-tertiary": "rgba(79, 110, 247, 0.10)",
					"--dsw-alias-interactive-bg-hover": "rgba(79, 110, 247, 0.10)",
					"--dsw-alias-interactive-bg-active": "rgba(79, 110, 247, 0.16)",
					"--dsw-alias-markdown-code-block": "#f3f4f6",
					"--dsw-alias-markdown-inline-code": "rgba(79, 110, 247, 0.10)",
					"--dsw-specific-sidebar-fill": "rgba(255, 255, 255, 0.85)",
					"--dsw-specific-sidebar-nav-item-active": "#eef1fb",
					"--dsw-specific-sidebar-nav-item-hover": "rgba(17, 24, 39, 0.04)",
					"--dsw-alias-scrollbar-bg-l1": "#e5e7eb",
					"--dsw-alias-scrollbar-bg-l2": "#d1d5db",
					"--dsw-alias-scrollbar-hover-l1": "#9ca3af",
			...
			},
			{
				...
				colorScheme: "light",
				tokens: {
					// iOS/Linear 清透冷调重构：冷蓝白
					"--dsw-alias-bg-base": "#f3f6fa",
					"--dsw-alias-bg-layer-1": "rgba(255, 255, 255, 0.9)",
					"--dsw-alias-bg-layer-2": "rgba(255, 255, 255, 0.95)",
					"--dsw-alias-bg-layer-3": "rgba(226, 233, 242, 1)",
					"--dsw-alias-bg-overlay": "rgba(255, 255, 255, 0.92)",
					"--dsw-alias-border-l1": "rgba(30, 41, 59, 0.08)",
					"--dsw-alias-border-l2": "rgba(30, 41, 59, 0.14)",
					"--dsw-alias-label-primary": "#0f172a",
					"--dsw-alias-label-secondary": "#3f4f63",
					"--dsw-alias-label-tertiary": "#64748b",
					"--dsw-alias-brand-primary": "#2f6bf7",
					"--dsw-alias-brand-text": "#ffffff",
					"--dsw-alias-button-primary-hover": "#4a80f8",
					"--dsw-alias-button-primary-dimmed": "rgba(47, 107, 247, 0.10)",
					"--dsw-alias-state-business-primary": "#2f6bf7",
					"--dsw-alias-state-business-tertiary": "rgba(47, 107, 247, 0.10)",
					"--dsw-alias-interactive-bg-hover": "rgba(47, 107, 247, 0.10)",
					"--dsw-alias-interactive-bg-active": "rgba(47, 107, 247, 0.16)",
					"--dsw-alias-markdown-code-block": "#e9eef5",
					"--dsw-alias-markdown-inline-code": "rgba(47, 107, 247, 0.10)",
					"--dsw-specific-sidebar-fill": "rgba(255, 255, 255, 0.85)",
					"--dsw-specific-sidebar-nav-item-active": "#e7edf5",
					"--dsw-specific-sidebar-nav-item-hover": "rgba(30, 41, 59, 0.04)",
					"--dsw-alias-scrollbar-bg-l1": "#d8dfe8",
					"--dsw-alias-scrollbar-bg-l2": "#c4ccd8",
					"--dsw-alias-scrollbar-hover-l1": "#9aa8ba",
					"--dsw-alias-scrollbar-hover-l2": "#9aa8ba"
				}
			},
			{
				id: "rose",
				colorScheme: "light",
				tokens: {
					// iOS/Linear 清透冷调重构：现代克制粉（非甜腻）
					"--dsw-alias-bg-base": "#f7f2f5",
					"--dsw-alias-bg-layer-1": "rgba(255, 255, 255, 0.9)",
					"--dsw-alias-bg-layer-2": "rgba(255, 255, 255, 0.95)",
					"--dsw-alias-bg-layer-3": "rgba(244, 230, 237, 1)",
					"--dsw-alias-bg-overlay": "rgba(255, 255, 255, 0.92)",
					"--dsw-alias-border-l1": "rgba(140, 66, 100, 0.08)",
					"--dsw-alias-border-l2": "rgba(140, 66, 100, 0.14)",
					"--dsw-alias-label-primary": "#2a1420",
					"--dsw-alias-label-secondary": "#6d4a5a",
					"--dsw-alias-label-tertiary": "#8f6d7c",
					"--dsw-alias-brand-primary": "#d2477e",
					"--dsw-alias-brand-text": "#ffffff",
					"--dsw-alias-button-primary-hover": "#dd5a90",
					"--dsw-alias-button-primary-dimmed": "rgba(210, 71, 126, 0.10)",
					"--dsw-alias-state-business-primary": "#d2477e",
					"--dsw-alias-state-business-tertiary": "rgba(210, 71, 126, 0.10)",
					"--dsw-alias-interactive-bg-hover": "rgba(210, 71, 126, 0.10)",
					"--dsw-alias-interactive-bg-active": "rgba(210, 71, 126, 0.16)",
					"--dsw-alias-markdown-code-block": "#f2e6ec",
					"--dsw-alias-markdown-inline-code": "rgba(210, 71, 126, 0.10)",
					"--dsw-specific-sidebar-fill": "rgba(255, 255, 255, 0.85)",
					"--dsw-specific-sidebar-nav-item-active": "#f0e2ea",
					"--dsw-specific-sidebar-nav-item-hover": "rgba(140, 66, 100, 0.04)",
					"--dsw-alias-scrollbar-bg-l1": "#e6d3dc",
					"--dsw-alias-scrollbar-bg-l2": "#dbc2cd",
					"--dsw-alias-scrollbar-hover-l1": "#c9a6b6",
					"--dsw-alias-scrollbar-hover-l2": "#c9a6b6"
				}
			}
		];
		...
		const es = {
			...
			"skin.abyss": "Abismo",
			"skin.aurora": "Aurora",
			"skin.nebula": "Nebulosa",
			"skin.ember": "Ascuas",
			"skin.midnight": "Medianoche",
			"skin.ivory": "Marfil",
			"skin.mist": "Niebla azul",
			"skin.rose": "Rosa",
		...
		const fr = {
			...
			"skin.abyss": "Abysse",
			"skin.aurora": "Aurore",
			"skin.nebula": "Nébuleuse",
			"skin.ember": "Braises",
			"skin.midnight": "Minuit",
			"skin.ivory": "Ivoire",
			"skin.mist": "Brume bleue",
			"skin.rose": "Rose",
		...
		const de = {
			...
			"skin.ivory": "Elfenbein",
			"skin.mist": "Morgennebel",
			"skin.rose": "Rosé",
		...
		const ru = {
			...
			"skin.abyss": "Бездна",
			"skin.aurora": "Аврора",
			"skin.nebula": "Туманность",
			"skin.ember": "Угли",
			"skin.midnight": "Полночь",
			"skin.ivory": "Слоновая кость",
			"skin.mist": "Утренний туман",
			"skin.rose": "Розовый",
		...
		/** The injected premium-material <style> node (glass blur + hairline sheen). */
		...
		//#region dsh-dream-skin: premium material (glass) CSS
		/**
		 * Ingest a small, self-contained <style> that upgrades DSH's main layout
		 * columns to a frosted-glass "material" when a diffused-glow wallpaper is
		 * present — the premium iOS feel. It targets DSH's official layout class
		 * names, so it is version-sensitive:
		 *   - `.pI_x6G_centerCol`  (main chat column)
		 *   - `.hHd-Xa_root`       (sidebar root)
		 * If a class name changes in a future DSH the rule silently no-ops (selectors
		 * simply stop matching), so this can never break the layout — it only stops
		 * adding blur. `@supports` also guards against browsers without
		 * backdrop-filter. The node is created lazily and removed by teardown.
		 */
		const MATERIAL_CSS_SOURCE = "dsh-dream-skin:material:glass";
		...
		/** Remove the injected material <style> node on fiber unload. */
		...
		function apply(ctx) {
			...
			// Upgrade the main layout columns to a frosted-glass material (premium
			// feel). No-ops safely if DSH's hashed class names change in a future
			// version — the selectors just stop matching; it never breaks layout.
			ensureMaterialStyle();
			...
			const skinInjected = (actions) => {
				...
				return {
					setSkin: (id) => {
						...
						syncSkinWith(id);
						// iOS premium look: when the user hasn't set a wallpaper of their
						// own yet, auto-attach this skin's recommended diffused-glow
						// gradient so the chosen theme carries its matching material
						// background. A user-chosen wallpaper is always left untouched.
						if (!userSetWallpaper()) {
							const gradient = wallpapersSuggestionsFor(id);
							if (gradient) setWallpaperKind(ctx, "gradient", gradient);
						}
					}
				};
			};
